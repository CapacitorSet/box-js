...
let code = fs.readFileSync("patch.js", "utf8") + fs.readFileSync("sample.js", "utf8");

if (code.match("</")) { // The sample may actually be a .wsf, which is <job><script>..</script><script>..</script></job>.
